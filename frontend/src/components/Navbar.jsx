    ...
    <nav className="glass sticky top-0 z-50 border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link to={user ? "/properties" : "/"} className="flex items-center space-x-2">
          ...
          <div className="hidden md:flex items-center space-x-1">
            {user ? (
              ...
              <Button onClick={login} className="bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))]/90">
                Sign In
              </Button>
            )}
          </div>
          ...
          <div className="md:hidden flex items-center gap-2">
            {user ? (
                      ...
                      {navItems.map((item) => {
                        ...
                        return (
                          <Button
                            key={item.path}
                            variant={isActive ? "default" : "ghost"}
                            className={`justify-start ${isActive ? 'bg-[hsl(var(--primary))] text-white' : ''}`}
              ...
              <Button onClick={login} size="sm" className="bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))]/90">
                Sign In
              </Button>
            )}
          </div>
